    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '2rem' }}>
        <div style={{ minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
            <div style={{
              ...
              <Terminal size={14} color="var(--color-polar-white)" />
            </div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', fontFamily: 'JetBrains Mono, monospace', overflowWrap: 'anywhere' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <a href="https://linkedin.com/in/meritxellgv" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)', transition: 'transform 0.2s' }}
            onMouseOver={e => e.currentTarget.style.transform = 'translateY(-2px)'}
            onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'}>
            <Linkedin size={20} />
          </a>
          <a href="mailto:meritxellguzman1@gmail.com" style={{ color: 'var(--text-primary)', transition: 'transform 0.2s' }}
            onMouseOver={e => e.currentTarget.style.transform = 'translateY(-2px)'}
            onMouseOut={e => e.currentTarget.style.transform = 'translateY(0)'}>
            <Mail size={20} />
          </a>
